...
from src.ingestion.loaders.audio_loader import AudioLoader
...
DEFAULT_LOADERS = [MarkdownLoader(), TextLoader(), PDFLoader(), JSONLoader(), CSVLoader(), ImageLoader(), AudioLoader()]
